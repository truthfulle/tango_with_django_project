...
class Chapter3ProjectStructureTests(TestCase):
    ...
    def test_project_created(self):
        ...
        urls_module_exists = os.path.isfile(os.path.join(self.project_base_dir, 'tango_with_django_project',
                                                         'rango/urls.py'))
    ...
    def test_rango_app_created(self):
        ...
        is_python_package = os.path.isfile(os.path.join(self.rango_app_dir, 'rango/__init__.py'))
        views_module_exists = os.path.isfile(os.path.join(self.rango_app_dir, 'rango/views.py'))
    ...
    def test_rango_has_urls_module(self):
        ...
        """
        module_exists = os.path.isfile(os.path.join(self.rango_app_dir, 'rango/urls.py'))
